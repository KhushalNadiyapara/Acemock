              ...
              <CollapsibleContent>
                <div className="flex flex-col gap-2">
                  ...
                  <h2 className="p-2 border rounded-lg bg-red-50 text-sm text-red-900">
                    <strong>Your Answer: </strong> {items.userAns}
                  </h2>
                  <h2 className="p-2 border rounded-lg bg-green-50 text-sm text-green-900">
                    <strong>Correct Answer: </strong> {items.correctAns}
                  </h2>
                  <h2 className="p-2 border rounded-lg bg-purple-50 text-sm text-primary">
                    <strong>Feedback: </strong> {items.feedback}
                  </h2>
                </div>
              </CollapsibleContent>
            </Collapsible>
